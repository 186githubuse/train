...
export const Q01 = [
  /* ─────────── 难度 1：基础识别（9题） ─────────── */
  {
    ...
    correct: 'C',
    explanation: '"甜不甜"是味道，属于口尝感觉点，必须用嘴巴尝才能直接感觉到。',
  },

  {
    ...
    correct: 'B',
    explanation: '感觉就是用眼、耳、鼻、口、手五个感觉器官获取事物特点的过程。',
  },
...

  {
    ...
    options: { A: '正确', B: '错误' },
    correct: 'B',
    explanation: '"想"是大脑的思维活动，不是用感觉器官获取的，所以不属于感觉。',
  },

  {
    ...
    leftItems: { '①': '欣赏烟花绽放的颜色', '②': '感受妈妈做的饭菜香', '③': '感受小鸟叽叽喳喳叫' },
    rightItems: { 'A': '耳听', 'B': '眼看', 'C': '鼻闻' },
    correct: { '①': 'B', '②': 'C', '③': 'A' },
    explanation: '看颜色用眼，闻味道用鼻，听声音用耳，每种感觉对应不同的器官。',
  },

  {
    ...
    correct: 'A',
    explanation: '"白毛""绿水"都是颜色，颜色靠眼睛看到。',
  },

  {
    ...
    correct: 'C',
    explanation: '"猜"是脑子里的思维活动，不是用感觉器官直接获取信息，所以不属于感觉。',
  },

  {
    ...
    correct: ['A', 'B', 'C', 'D', 'E'],
    explanation: '五个感觉器官——眼、耳、鼻、口（舌）、手（皮肤），分别对应看、听、闻、尝、摸五种感觉。',
  },

  {
    ...
    correct: 'C',
    explanation: '"暗香"是淡淡的香气，靠鼻子闻到，属于鼻闻感觉点。',
  },
  ...
  /* ─────────── 难度 2：简单应用（9题） ─────────── */
  {
    ...
    correct: 'B',
    explanation: '写好作文离不开感觉，亲自用五感去感受才能获得真实丰富的素材。',
  },

  {
    ...
    correct: ['A', 'B', 'C', 'D'],
    explanation: 'A 眼看、B 鼻闻、C 耳听、D 口尝都是直接感觉获得的素材；E 是科学思考，不属于感觉。',
  },

  {
    ...
    correct: 'A',
    explanation: '"黄""翠"是颜色（眼看），"鸣"是声音（耳听）。',
  },

  {
    ...
    correct: 'B',
    explanation: '只有亲身用感觉器官去看、去摸，才能获得真实生动的描述素材。',
  },

  {
    ...
    correct: 'B',
    explanation: '"稻花香"是鼻闻到的气味，"蛙声"是耳听到的声音。',
  },

  {
    ...
    correct: 'B',
    explanation: '写作素材应来自看、摸等具体感觉，不能只写抽象的"想"。',
  },

  {
    ...
    correct: ['A', 'D'],
    explanation: '"歌"是鹅的叫声，"鹅，鹅，鹅"模仿的也是鹅鸣，都是耳听到的；B、C 是眼看到的颜色和动作。',
  },

  {
    ...
    options: { A: '②-③-①', B: '①-②-③', C: '③-②-①', D: '②-①-③' },
    correct: 'A',
    explanation: '感觉一个事物通常先看（眼）再闻（鼻）最后尝（口），符合自然认知顺序。',
  },

  {
    ...
    correct: 'C',
    explanation: '感觉是写作的基础，能为作文提供具体生动的素材，但作文还需要思维加工。',
  },

  /* ─────────── 难度 3：综合迁移（12题，含 S5/C4/H3 学段） ─────────── */
  /* (S) 小学段 5 题 */
  {
    id: 'K1-D3-S01',
    lessonId: 1,
    ...
    correct: 'B',
    explanation: '亲临现场，用眼看、耳听等多种感觉获取的素材，最真实生动。',
  },

  {
    ...
    correct: 'B',
    explanation: '想象的根基是仔细观察。只有先用眼睛感觉过雾的样子，才能联想到猫的姿态。',
  },

  {
    ...
    correct: 'C',
    explanation: '圆圆调用了多种感觉（耳听"呼呼"、眼看"吹弯""打着旋儿"），写出风的具体表现，比抽象的"真大"更生动。',
  },

  {
    ...
    correct: 'B',
    explanation: '抽象情感要靠具体感觉材料来呈现，让读者能看到、听到、感受到。',
  },

  {
    ...
    correct: 'B',
    explanation: '好词好句必须建立在真实感觉的基础上，否则就是空中楼阁，乙的比喻更恰当。',
  },
  ...
  /* (C) 初中段 4 题 */
  {
    ...
    correct: 'B',
    explanation: '作家从感觉出发，素材具体；学生从概念出发，描写容易空泛。',
  },

  {
    ...
    correct: 'B',
    explanation: '"碧绿""光滑""紫红"分别来自眼看、手摸等多种感觉，源于童年丰富的感官体验。',
  },

  {
    ...
    correct: 'D',
    explanation: 'A、B、C、E 都是用感觉器官直接获取的素材；D 是思维想象，对写诱人的推荐语作用不如直接感觉。',
  },

  {
    ...
    correct: 'C',
    explanation: '"气息""味儿""香"都是鼻子闻到的，属于嗅觉。',
  },
  ...
  /* (H) 高中段 3 题 */
  {
    ...
    correct: 'A',
    explanation: '深刻的哲思往往源于真实而强烈的感觉经验，感觉是文学的根基。',
  },

  {
    ...
    correct: 'B',
    explanation: '"用鼻子写作"是一种夸张说法，强调嗅觉与气味记忆能唤起整个场景，是文学创作的重要素材来源。',
  },

  {
    ...
    correct: 'B',
    explanation: '无论绘画还是写作，创造性的表达都要从精细深入的感觉/感知开始。',
  },
];

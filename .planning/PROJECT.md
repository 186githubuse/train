...
面向 1-12 年级学生的感觉训练闯关 App，通过 10 节课 + 297 道题（含分学段）帮助学生培养写作感知力（看/听/闻/尝/摸五感）。纯原生 Web 应用，移动端优先，马卡龙液态玻璃风格。核心功能已全部完成，当前处于客户测试阶段，已部署到腾讯云 EdgeOne Pages（国内首选）+ Vercel + GitHub Pages，备案后将切换到 COS+CDN。
...
- ✓ 答题页（每轮 10 题、错≤3 通关、错>3 补测 3 题、按通过轮次评星）— 2026-05-15 重写
